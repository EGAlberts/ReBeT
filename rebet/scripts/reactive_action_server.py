...
from rebet_msgs.action import Reactive
...
class ReactiveActionServer(Node):
    ...
    def execute_callback(self, goal_handle):
        ...
        while True:
            ...
            if self.qr_values['PowerQR'] < self.energy_high_threshold: #if I'm using too much power
                self.decrease_picture_rate() #lower the picture rate
                
            elif(self.qr_values['TaskEfficiencyQR'] < self.mission_low_threshold): #If I'm not using too much power, and my taskefficiency is higher than this value, increase it?
