...
cd scripts
gnome-terminal  --profile=closeonkill  -- ./rosanything.sh reactive_action_servers_launch.py
sleep 3
...
sleep 15
gnome-terminal  --profile=closeonkill  -- ./arborist.sh $1 onlyIDReactive.xml
sleep 5
