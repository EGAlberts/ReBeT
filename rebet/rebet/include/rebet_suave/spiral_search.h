...
#include "suave_msgs/action/spiral.hpp"
...
public:  
  ...
  SpiralSearch(const std::string& name,
                  const NodeConfig& conf,
                  const RosNodeParams& params)
    : RosActionNode<Spiral>(name, conf, params)
  {
    std::cout << "Someone made me (an SpiralSearch Action Nodee)" << std::endl;
