...
public:
  ...
  {
    return {InputPort<double>(
        WEIGHT,
        "How much influence this QR should have in the calculation of system utility"),
...
protected:
  ...
  void metric_mean()
  {
    double new_average = _average_metric +
      ((_metric - _average_metric) / (double)_times_calculated);
